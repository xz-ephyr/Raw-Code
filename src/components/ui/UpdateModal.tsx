...
export default function UpdateModal({ update, onInstall, onLater }: UpdateModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/30">
      <div className="bg-card rounded-xl shadow-2xl shadow-black/30 p-6 max-w-md w-full mx-4 animate-in fade-in zoom-in-95 duration-200">
        ...
        {update.body && (
          <div className="mt-4 p-3 bg-muted rounded-lg border border-border max-h-40 overflow-y-auto">
