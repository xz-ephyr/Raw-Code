...
export default function TitleBar() {
  ...
  return (
    <div className="group flex items-center h-9 px-4 bg-[#2a2a2a] shrink-0 select-none">
      {isEditing ? (
        <input
          ref={inputRef}
          value={editValue}
          ...
          className="w-full max-w-[400px] bg-[#2a2a2a] border border-neutral-600 rounded-[6px] px-2 py-0.5 text-sm font-semibold text-neutral-200 focus:outline-none focus:ring-1 focus:ring-neutral-400/30"
        />
      ) : isTitleGenerating ? (
        ...
        >
          <span className="text-sm font-semibold text-neutral-300 truncate">{displayTitle}</span>
          <span className="shrink-0 text-neutral-600 opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer">
