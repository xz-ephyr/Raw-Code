  ...
  return (
    <span ref={ref} className="inline-source-pill relative inline-flex items-center mx-0.5 align-middle">
      <a
        ...
        className="inline-flex items-center justify-center w-[18px] h-[18px] rounded-full bg-[#2a2a2a] hover:bg-neutral-800 border border-neutral-600 transition-colors no-underline shadow-sm hover:shadow-md cursor-pointer"
        title={title || domain}
      >
      ...
      {isOpen && (
        ...
        >
          <span className="block bg-[#2a2a2a] border border-neutral-700 rounded-lg shadow-lg p-3 min-w-[220px] max-w-[320px]">
            ...
            <span className="block absolute left-0 top-1/2 -translate-x-1/2 -translate-y-1/2 rotate-45 w-2 h-2 bg-[#2a2a2a] border-l border-b border-neutral-700" />
          </span>
        </span>
      )}
    </span>
