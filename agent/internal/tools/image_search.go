...
func imageSearchTool() ToolDef {
	return ToolDef{
		...
		Handler: func(ctx context.Context, e ExecutorInterface, params map[string]any) (any, error) {
			...
			return postToExpress(ctx, e.GetExpressURL(), "imageSearch", map[string]any{
				"query":      query,
